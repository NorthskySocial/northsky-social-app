...
/** Tabler: bell (outline) */
export const Bell2_Stroke2_Corner0_Rounded = createTablerIcon({
  paths: [
...
/** Tabler: bell (filled) */
export const Bell2_Filled_Corner0_Rounded = createTablerFilledIcon({
  paths: [
...
export const Bell2Off_Stroke2_Corner0_Rounded = createTablerIcon({
  paths: [
    'M13 17h-9a4 4 0 0 0 2 -3v-3a7 7 0 0 1 4 -6a2 2 0 1 1 4 0a7 7 0 0 1 4 6v2',
    'M9 17v1a3 3 0 0 0 4.194 2.753',
    'M22 22l-5 -5',
    'M17 22l5 -5',
  ],
})
...
export const Bell2Off_Filled_Corner0_Rounded = createTablerFilledIcon({
  paths: [
    'M14.235 19c.865 0 1.322 1.024 .745 1.668a3.992 3.992 0 0 1 -2.98 1.332a3.992 3.992 0 0 1 -2.98 -1.332c-.552 -.616 -.158 -1.579 .634 -1.661l.11 -.006h4.471z',
