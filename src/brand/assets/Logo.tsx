...
/** The Northsky logomark is rendered on a square 1024x1024 viewBox. */
const ratio = 1
...
export const BrandLogo = forwardRef(function BrandLogoImpl(props: Props, ref) {
  ...
  const useGradient = !fill || fill === 'sky'
  const pathFill = useGradient ? 'url(#northsky-logo-gradient)' : fill
