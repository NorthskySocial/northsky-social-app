 ...
 * keyed by highlight.js scope, and the code panel background.
 */
...
// Panel background for rendered code. `bg_contrast_25` goes the wrong way in
// dark themes (lighter than bg), so these are set explicitly.
