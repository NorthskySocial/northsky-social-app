...
describe('toNiceDomain', () => {
  const inputs = [
    ...
    'https://bsky.app',
    'https://northsky.social', // northsky: default service maps to the brand name
    '#123123123',
  ]
  const outputs = ['example.com', 'bsky.app', 'Northsky', '#123123123']
...
describe('toShareUrl', () => {
  // northsky: relative paths get the brand host; absolute URLs pass through
